...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-3 text-danger" style="font-weight:bolder"><h4 align="right">Update Brands Here:</h4></div>
        <div class="col-md-7">
        <div class="input-group" >
        <input type="text" class="form-control"  name="new_brand" value="<?php echo $brand_title; ?>">
        <span class="input-group-btn">
        <input class="btn btn-success" name="update_brand" type="submit" value="Update"/>
        </span>
    </div>
